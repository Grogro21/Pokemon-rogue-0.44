...
class EBDXBitmapWrapper
  ...
  FRAME_UPDATE_TIME = 0.05

  attr_reader :width, :height, :total_frames, :frame_idx
  attr_accessor :scale, :frame_skip, :constrict_x, :constrict_y
  #-----------------------------------------------------------------------------
  #  class constructor
  #-----------------------------------------------------------------------------
  ...
  def compile_strip; self.refresh(@strip); end
  ...
  #-----------------------------------------------------------------------------
  #  manipulation of animation frames
  #-----------------------------------------------------------------------------
  def set_speed(value); @speed = value * 2; end
  ...
  def update
    ...
    return if (System.uptime - @frame_time) < @speed * FRAME_UPDATE_TIME
